...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    title: 'Peregrine - Complaints and Labor Services System',
    titleAr: 'بيرجرين - نظام الشكاوى وخدمة العمالات',
    client: 'Bargrain Security Services Company',
    clientAr: 'شركة برجراين للخدمات الأمنية',
    clientLogo: '@assets/pre_1761856733947.webp',
    sector: 'Security Services',
    ...
    kpis: [
      {
        ...
        labelAr: 'كفاءة الاستجابة',
        value: '88%',
        description: 'Faster complaint processing and resolution',
      ...
      },
      {
        ...
        labelAr: 'إدارة الحراس',
        value: '95%',
        description: 'Complete digital tracking of guard operations',
        descriptionAr: 'تتبع رقمي كامل لعمليات الحراس',
        icon: 'Shield',
        trend: 'up'
      },
      {
        ...
        labelAr: 'توثيق الحوادث',
        value: '97%',
        description: 'Accurate incident reporting and documentation',
        descriptionAr: 'تقارير وتوثيق دقيق للحوادث',
        icon: 'AlertTriangle',
        trend: 'up'
      },
      {
        ...
        labelAr: 'موثوقية النظام',
        value: '99.8%',
        description: 'System uptime and availability',
        descriptionAr: 'وقت تشغيل النظام وتوافره',
        icon: 'TrendingUp',
        trend: 'up'
      }
    ],
    tech: ['ASP.NET Core 8.0', 'C#', 'Flutter', 'Dart', 'SQL Server 2019', 'Entity Framework Core', 'RESTful APIs', 'JWT', 'Swagger UI'],
    coverImage: '@assets/33_1761858779080.webp',
    gallery: [
      {
        id: '1',
        url: '@assets/11_1761858779079.webp',
        alt: 'Peregrine splash screen with security logo',
        altAr: 'شاشة البداية لبيرجرين مع شعار الأمان',
        type: 'image',
        caption: 'Security-focused application splash screen',
        captionAr: 'شاشة البداية للتطبيق المركز على الأمان'
      },
      {
        id: '2',
        url: '@assets/22_1761858779079.webp',
        alt: 'Peregrine login interface',
        altAr: 'واجهة تسجيل الدخول لبيرجرين',
        type: 'image',
        caption: 'Secure authentication with role-based access',
        captionAr: 'مصادقة آمنة مع وصول قائم على الأدوار'
      },
      {
        id: '3',
        url: '@assets/33_1761858779080.webp',
        alt: 'Peregrine main dashboard',
        altAr: 'لوحة تحكم بيرجرين الرئيسية',
        type: 'image',
        caption: 'Main dashboard with quick access to key features',
        captionAr: 'لوحة معلومات رئيسية مع وصول سريع للميزات الأساسية'
      },
      {
        id: '4',
        url: '@assets/44_1761858779080.webp',
        alt: 'Request tracking interface',
        altAr: 'واجهة تتبع الطلبات',
        type: 'image',
        caption: 'Comprehensive request and complaint tracking',
        captionAr: 'تتبع شامل للطلبات والشكاوى'
      },
      {
        id: '5',
        url: '@assets/55_1761858779080.webp',
        alt: 'Complaint details and chat interface',
        altAr: 'تفاصيل الشكوى وواجهة المحادثة',
        type: 'image',
        caption: 'Real-time communication for complaint resolution',
        captionAr: 'تواصل فوري لحل الشكاوى'
      },
      {
        id: '6',
        url: '@assets/66_1761858779080.webp',
        alt: 'Monthly subscription inquiry interface',
        altAr: 'واجهة الاستفسار عن الاشتراك الشهري',
        type: 'image',
        caption: 'Subscription management and inquiry system',
        captionAr: 'نظام إدارة الاشتراكات والاستفسارات'
      }
    ],
    summaryEn: 'Comprehensive security workforce management system for guards, contracts, complaints, and incident tracking with real-time communication.',
    summaryAr: 'نظام متكامل لإدارة القوى العاملة الأمنية للحراس والعقود والشكاوى وتتبع الحوادث مع التواصل الفوري.',
    descriptionEn: 'Peregrine is an integrated system designed specifically for managing security guards, contracts, and incidents. Developed using modern technologies, it provides an automated and user-friendly solution for managing daily operations in security institutions and guard companies. The application unifies surveillance, reporting, human resources management, contracts, and incidents in a single platform with seamless synchronization between backend and frontend.',
    descriptionAr: 'بيرجرين هو نظام متكامل لإدارة الحراس الأمنيين والعقود والحوادث، تم تطويره باستخدام تقنيات حديثة ليوفر حلاً مؤتمتًا وسهل الاستخدام لإدارة العمليات اليومية في المؤسسات الأمنية أو شركات الحراسة. يهدف التطبيق إلى توحيد عمليات المراقبة والتبليغ وإدارة الموارد البشرية والعقود والحوادث في منصة واحدة متصلة بين الواجهة الخلفية والواجهة الأمامية بشكل متزامن وفعّال.',
    challengeEn: 'Security service companies needed a comprehensive digital solution to manage guard operations, track contracts, handle complaints, and document incidents efficiently. The challenge was to create a system that provides real-time communication, role-based access control, and seamless integration between mobile applications and backend services while ensuring data security and system reliability.',
    challengeAr: 'احتاجت شركات الخدمات الأمنية إلى حل رقمي شامل لإدارة عمليات الحراس وتتبع العقود ومعالجة الشكاوى وتوثيق الحوادث بكفاءة. كان التحدي هو إنشاء نظام يوفر التواصل الفوري والتحكم في الوصول القائم على الأدوار والتكامل السلس بين تطبيقات الهاتف المحمول وخدمات الخادم مع ضمان أمان البيانات وموثوقية النظام.',
    solutionEn: 'We developed a complete cross-platform solution with ASP.NET Core backend and Flutter frontend. The system features secure authentication with JWT, RESTful APIs for seamless communication, comprehensive guard management, contract administration, real-time incident reporting, complaint tracking system with chat interface, role-based permissions (Admin/Guard/Supervisor), and interactive dashboards for monitoring all operations with backup and recovery capabilities.',
    solutionAr: 'طورنا حلاً كاملاً متعدد المنصات باستخدام ASP.NET Core للخادم الخلفي وFlutter للواجهة الأمامية. يتميز النظام بمصادقة آمنة مع JWT، وواجهات RESTful APIs للتواصل السلس، وإدارة شاملة للحراس، وإدارة العقود، وإبلاغ فوري عن الحوادث، ونظام تتبع الشكاوى مع واجهة محادثة، وصلاحيات قائمة على الأدوار (مدير/حارس/مشرف)، ولوحات معلومات تفاعلية لمراقبة جميع العمليات مع إمكانيات النسخ الاحتياطي والاستعادة.',
    services: ['Custom Software Development', 'Mobile App Development', 'Backend API Development', 'Database Architecture', 'Security Implementation', 'Cross-platform Solutions'],
    servicesAr: ['تطوير برمجيات مخصصة', 'تطوير تطبيقات الجوال', 'تطوير واجهات الخادم', 'هندسة قواعد البيانات', 'تنفيذ الأمان', 'حلول متعددة المنصات'],
    duration: '8 months',
    durationAr: '8 أشهر',
    teamSize: 10,
    features: [
    ...
    featuresAr: [
      'مصادقة آمنة وتفويض JWT',
      'إدارة ملفات الحراس',
      'نظام إدارة العقود',
      'الإبلاغ عن الحوادث وتوثيقها',
      'تتبع الشكاوى في الوقت الفعلي',
      'واجهة تواصل قائمة على المحادثة',
      'التحكم في الوصول القائم على الأدوار',
      'لوحة معلومات تفاعلية وتحليلات',
      'تطبيق جوال متعدد المنصات (Android/iOS)',
      'تكامل واجهات RESTful API',
      'نظام النسخ الاحتياطي والاستعادة',
      'دعم متعدد اللغات (عربي/إنجليزي)'
    ],
    results: [
      '88% faster complaint processing and resolution',
      '95% complete digital tracking of guard operations',
      '97% accurate incident documentation',
      '99.8% system uptime and reliability',
      'Real-time communication between guards and management',
      'Seamless cross-platform experience (Android/iOS/Web)'
    ],
    resultsAr: [
      '88% أسرع في معالجة وحل الشكاوى',
      '95% تتبع رقمي كامل لعمليات الحراس',
      '97% توثيق دقيق للحوادث',
      '99.8% وقت تشغيل النظام وموثوقيته',
      'تواصل فوري بين الحراس والإدارة',
      'تجربة سلسة متعددة المنصات (Android/iOS/Web)'
    ],
    testimonial: {
      name: 'Nabil Al-Siyani',
      nameAr: 'نبيل السياني',
      position: 'CEO, Bargrain Security Services',
      positionAr: 'المدير التنفيذي، برجراين للخدمات الأمنية',
      content: 'Peregrine has revolutionized how we manage our security workforce. The system provides complete visibility of all guard operations, contracts, and incidents with instant access to critical information. Real-time complaint tracking and communication features have significantly improved our service quality and client satisfaction.',
      contentAr: 'نظام بيرجرين أحدث ثورة في طريقة إدارة القوى العاملة الأمنية لدينا. يوفر النظام رؤية كاملة لجميع عمليات الحراس والعقود والحوادث مع وصول فوري للمعلومات الحيوية. ميزات تتبع الشكاوى والتواصل الفوري حسنت جودة خدماتنا ورضا العملاء بشكل كبير.',
      rating: 5
    }
  },
  {
