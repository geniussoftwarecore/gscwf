  ...
  const timeline = [
    {
      ...
      description: "بدأنا رحلتنا بالتركيز الكامل على رضا العملاء وتقديم خدمات استثنائية تتجاوز التوقعات",
    },
    {
      year: "2024",
      title: "شراكات ناجحة",
      description: "بنينا علاقات طويلة الأمد مع عملائنا من خلال الشفافية والمصداقية والجودة العالية",
    },
    {
      year: "2024",
      title: "دعم متواصل",
      description: "أطلقنا نظام دعم فني متطور متاح على مدار الساعة لخدمة عملائنا في أي وقت",
    },
    {
      year: "2025",
      title: "الابتكار لأجل العملاء",
      description: "طورنا حلولاً مخصصة وأدوات متقدمة لتلبية احتياجات عملائنا بشكل أسرع وأكثر كفاءة",
    },
  ];
